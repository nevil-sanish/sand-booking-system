...
const AntigravityInner = ({
  ...
  particleSize = 2,
  lerpSpeed = 0.1,
  color = '#d4930d', // Match Mullonkal Sand branding color
  autoAnimate = false,
  particleVariance = 1,
  rotationSpeed = 0,
  depthFactor = 1,
  ...
  const particles = useMemo(() => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      temp.push({
        t, factor, speed, xFactor, yFactor, zFactor, mx: x, my: y, mz: z, cx: x, cy: y, cz: z, vx: 0, vy: 0, vz: 0, randomRadiusOffset
      });
    }
    return temp;
